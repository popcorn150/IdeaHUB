...
import { Lightbulb, TrendingUp, Eye, Heart, MessageCircle, Star, Calendar, Plus, Wallet } from 'lucide-react'
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400">Track your ideas and earnings</p>
        </div>
        <Link
          to="/upload"
