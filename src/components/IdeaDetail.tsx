...
export function IdeaDetail({ idea, onClose, onPurchase, onRemix }: IdeaDetailProps) {
  ...
  const [showPartnershipFlow, setShowPartnershipFlow] = useState(false)
  ...
  return (
    <>
              ...
              <div className="flex items-center justify-between py-4 border-y border-gray-700">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  {canRequestPartnership() && (
                    <button
                      onClick={() => setShowPartnershipFlow(true)}
      ...
      {/* Partnership Request Flow Modal */}
      {showPartnershipFlow && (
        <PartnershipRequestFlow
          idea={idea}
          onClose={() => setShowPartnershipFlow(false)}
          onSuccess={() => {
            setShowPartnershipFlow(false)
            onClose()
          }}
        />
      )}
